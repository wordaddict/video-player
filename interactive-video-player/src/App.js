    ...
    return (
      <div className="player">
        ...
        <div className="player__controls">
          ...
          <input type="range" name="volume" className="player__slider" min="0" max="1" step="0.05" value="1"></input>
          <input type="range" name="playbackRate" className="player__slider" min="0.5" max="2" step="0.1" value="1"></input>
